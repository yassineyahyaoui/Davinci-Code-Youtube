...
def download_videos(targeted_channel, video_id):
    ...
    yt.streams.filter(progressive=True, file_extension='mp4').order_by('resolution').desc().first().download("C:/Users/DELL/PycharmProjects/Davinci-Code-Youtube/data/" + targeted_channel + "/" + video_id)
