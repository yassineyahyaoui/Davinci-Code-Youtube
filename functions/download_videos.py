...
def check_downloaded_videos_file(targeted_channel):
    ...
    if ("Channel name" or "Video id" or "Video title" or "Video description" or "Video thumbnail" or "Video rating" or "Video view count" or "Video like count" or "Video comment count" or "Video license" or "Video duration" or "Video publish time") not in content:
        file_downloaded_videos = open(os.path.join("data", targeted_channel, "downloaded_videos.csv"), "w", newline="")
        row = ("Channel name", "Video id", "Video title", "Video description", "Video thumbnail", "Video rating", "Video view count", "Video like count", "Video comment count", "Video license", "Video duration", "Video publish time")
    ...
    for video in videos_list:
        if video["Video id"] == video_id:
            file_downloaded_videos = open(os.path.join("data", targeted_channel, "downloaded_videos.csv"), "a",
                                          newline="")
            row = (video["Channel name"], video["Video id"], video["Video title"], video["Video description"], video["Video thumbnail"],
...
def update_videos_file(targeted_channel, video_id):
    ...
    row = ("Channel name", "Video id", "Video title", "Video description", "Video thumbnail", "Video rating", "Video view count",
    ...
    for video in videos_list:
        if video["Video id"] != video_id:
            ...
            row = (video["Channel name"], video["Video id"], video["Video title"], video["Video description"], video["Video thumbnail"], video["Video rating"], video["Video view count"], video["Video like count"], video["Video comment count"], video["Video license"], video["Video duration"], video["Video publish time"])
            csv.writer(file_videos).writerow(row)
            file_videos.close()
